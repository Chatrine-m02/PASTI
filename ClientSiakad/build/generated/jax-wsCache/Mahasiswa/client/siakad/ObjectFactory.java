 ...
 * generated in the client.siakad package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMahasiswa_QNAME = new QName("http://mahasiswa.siakad/", "getMahasiswa");
    private final static QName _AddMahasiswaResponse_QNAME = new QName("http://mahasiswa.siakad/", "addMahasiswaResponse");
    private final static QName _GetMahasiswaResponse_QNAME = new QName("http://mahasiswa.siakad/", "getMahasiswaResponse");
    private final static QName _EditMahasiswa_QNAME = new QName("http://mahasiswa.siakad/", "editMahasiswa");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: client.siakad
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mahasiswa.siakad/", name = "getMahasiswa")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mahasiswa.siakad/", name = "getMahasiswaResponse")
